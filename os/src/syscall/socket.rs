use crate::{task::*, fs::FileDescriptor, mm::copy_to_user};
use super::errno::*;
...
pub fn sys_socket(_domain: u32, _type: u32, _protocol: u32) -> isize {
    ...
    fd_table[new_fd] = Some(FileDescriptor::new(
...
pub fn sys_sendto(_sockfd: usize, _buf: *const u8, _len: usize, _flags: u32, _dest_addr: *const u8, _addrlen: u32) -> isize {
    1
}
pub fn sys_recvfrom(_sockfd: usize, buf: *mut u8, _len: usize, _flags: u32, _src_addr: *const u8, _addrlen: u32) -> isize {
    let src = "x";
    let task = current_task().unwrap();
